...
//实现圆柱分割、拟合
    ...
    pass.setFilterFieldName("y");//限制y轴范围  https://www.jianshu.com/p/a1c6cd7d411b
    pass.setFilterLimits(0,0.4);
    pass.filter(*cloud_filtered);
    cout<<"Cloud_filtered has: "<<cloud->points.size()<<" data points."<<endl;

//    //限制x轴范围  https://www.jianshu.com/p/a1c6cd7d411b
//    pcl::PassThrough<pcl::PointXYZ> pass_x;
//    pass_x.setInputCloud(cloud);
//    pass_x.setFilterFieldName("y");
//    pass_x.setFilterLimits(0,10000);
